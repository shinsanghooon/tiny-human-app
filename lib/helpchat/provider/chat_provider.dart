...
import 'package:tiny_human_app/common/constant/firestore_constants.dart';

import '../model/message_chat.dart';

final chatProvider = StateNotifierProvider<ChatNotifier, List<dynamic>>((ref) {
  final FirebaseFirestore firebaseFirestore = FirebaseFirestore.instance;
  final FirebaseStorage firebaseStorage = FirebaseStorage.instance;
  return ChatNotifier(firebaseFirestore: firebaseFirestore, firebaseStorage: firebaseStorage);
});
